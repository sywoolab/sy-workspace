...
def main():
    ...
    def _training_diagnosis(log, today_str):
        ...
        if bad_count >= 2:
            ...
            verdict = ('yellow', '부분 보완 필요', '자전거 기반은 좋음. 러닝·브릭 비중 높여야 대가야/통영 목표 달성 가능.')
        else:
    ...
    # 대가야 입문대회는 참가/완주 목표라 시간 처방 계산에서는 제외한다.
    race_targets = [
    ...
    races = [
        ("2026-10-18", "대가야트라이애슬론 입문대회", "🎯 참가/완주"),
...
"""
    ...
    all_races_ext = [
        ...
        ("2026-10-18", "대가야트라이애슬론 입문대회", "10/18~19 개최", "🎯 목표대회: 참가/완주 + 전환 운영 점검"),
