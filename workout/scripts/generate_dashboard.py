...
"""
    ...
    all_races_ext = [
        ...
        ("2026-09-06", "거북섬 올림픽", "9/4~6 개최 · 수영 1.5+자전거 40+러닝 10km", "B레이스: 실전점검 + 올림픽 완주 2회차"),
        ("2026-10-18", "대가야 올림픽", "10/18~19 개최 · 수영 1.5+자전거 40+러닝 10km", "🎯 A레이스: sub-2:45 + 올림픽 완주 3회차"),
    ]
