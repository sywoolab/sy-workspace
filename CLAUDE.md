...
수영 수업/강습은 **실제 수업 등록된 고정 일정**이다. 훈련 선택이 아니라 출석해야 하는 일정이므로, 컨디션이 안 좋아도 "쉬라"고 하지 않는다. 수영은 부하가 낮아서 회복에 방해도 안 된다.
...
- 러닝/자전거는 컨디션에 따라 조정 가능
- 수영 수업은 조정 대상이 아님 (Easy로 해도 출석은 함)
- 일요일 휴식은 사용자 요청 (근골격계 부상 방지)
